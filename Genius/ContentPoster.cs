...
namespace Genius
{
    public class ContentPoster
    {
        ...
        public static async Task<Annotation> CreateAnnotation(string markdown, string rawAnnotableUrl, string fragment, string beforeHtml = "",
            string afterHtml = "", string canonicalUrl = "", string ogUrl = "", string title = "")
        {
            ...
            {
                var baseAddress = new Uri("https://api.genius.com/annotations");
