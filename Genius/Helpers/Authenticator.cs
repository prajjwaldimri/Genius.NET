...
namespace Genius.Helpers
{
    ...
    public class Authenticator
    {
        ...
        /// <summary>
        ///     The URI Genius will redirect the user to after they've authorized your application; it must be the same as the one
        ///     set for the API client on the management page.
        ///     This URL contains the `code` parameter as prefix and should be in the form of https://YOUR_REDIRECT_URI/?code=CODE
