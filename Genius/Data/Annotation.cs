...
namespace Genius.Data
{
	...
	public class AnnotationChild
	{
		[JsonProperty(PropertyName = "tag")]
		public string Tag { get; set; }
		// TODO: it is not a string[] it looks like:
		/*
		"children": [
            "The song is an uptempo, radio-friendly record. Three years after her greatest hit single ",
            {
                "tag": "a",
                "attributes": {
                    "href": "https://genius.com/Rita-ora-i-will-never-let-you-down-lyrics"
                },
                "data": {
                    "api_path": "/songs/392635"
                },
                "children": [
            ...
            " British singer and actress ",
            {
                "tag": "a",
                "attributes": {
                    "href": "https://genius.com/artists/Rita-ora"
                },
                "data": {
                    "api_path": "/artists/17853"
                },
                "children": [
                    "Rita Ora"
                ]
